...
namespace SIMPEngine
{
    ...
    public:
        ...
        virtual void DrawQuad(float x, float y, float width, float height, SDL_Color color, bool fill, float zIndex) = 0;
        ...
        virtual void DrawTexture(GLuint, float x, float y, float w, float h, SDL_Color tint, float rotation, float zIndex) = 0;
